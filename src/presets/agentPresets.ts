...
export const AGENT_TYPE_PRESETS: Record<string, AgentTypePreset> = {
  "coding-assistant": {
    ...
    sandboxMode: "none",
    toolPolicy: { profile: "coding", allow: ["browser", "web_search", "web_fetch"], deny: [] },
    heartbeatMode: "30m",
...
- Store architecture decisions and rationale`,
  ...
  "office-assistant": {
    ...
    sandboxMode: "none",
    toolPolicy: { profile: "messaging", allow: ["browser", "web_search", "web_fetch"], deny: [] },
    heartbeatMode: "1h",
    idleTimeoutMs: 3600000,
    enableFallbacks: true,
    identityMd: `# IDENTITY.md - Who Am I?
...
- Meeting notes and action items`,
  ...
  "travel-planner": {
    ...
    sandboxMode: "none",
    toolPolicy: { profile: "messaging", allow: ["browser", "web_search", "web_fetch", "image"], deny: [] },
    heartbeatMode: "never",
    idleTimeoutMs: 3600000,
    enableFallbacks: true,
    identityMd: `# IDENTITY.md - Who Am I?
